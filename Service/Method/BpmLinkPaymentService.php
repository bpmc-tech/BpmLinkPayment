...
namespace Plugin\BpmLinkPayment\Service\Method;
 ...
 */
class BpmLinkPaymentService implements PaymentMethodInterface
{
    /**
     * @var Order
     */
    ...
    public function apply()
    {
        ...
        $this->Order->setBpmLinkPaymentPaymentStatus($PaymentStatus);
        ...
        // Controller側に処理を移動
        $url = '/bpm_link_payment/'.$order_no.'/'.$pre_order_id.'/bridge';
